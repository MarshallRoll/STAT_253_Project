...
stroke <- read_csv("https://raw.githubusercontent.com/MarshallRoll/STAT_253_Project/main/healthcare-dataset-stroke-data.csv?token=GHSAT0AAAAAABYKVOXKMH7IB4EZKBMHI4YSYZWBEIQ")
...
Due to our model predicting a classification outcome, we've come to a stopping point due to our limitation on the knowledge of logistic regressions. we are unsure what would be a good evaluation metric as well as how to proceed with a logistic regression.  
